...
struct xrt_system_devices
{
	 ...
	 */
	xrt_result_t (*begin_feature)(struct xrt_system_devices *xsysd, enum xrt_device_feature feature);
	 ...
	 */
	xrt_result_t (*end_feature)(struct xrt_system_devices *xsysd, enum xrt_device_feature feature);
...
{
	return xsysd->begin_feature(xsysd, feature);
}
...
{
	return xsysd->end_feature(xsysd, feature);
}
