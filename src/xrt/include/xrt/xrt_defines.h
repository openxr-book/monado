...
\
	...
	_(XRT_INPUT_NOLO_SYSTEM_CLICK                      , XRT_INPUT_NAME(0x0600, BOOLEAN)) \
	_(XRT_INPUT_NOLO_SQUEEZE_CLICK                     , XRT_INPUT_NAME(0x0601, BOOLEAN)) \
	_(XRT_INPUT_NOLO_MENU_CLICK                        , XRT_INPUT_NAME(0x0602, BOOLEAN)) \
	_(XRT_INPUT_NOLO_TRIGGER_CLICK                     , XRT_INPUT_NAME(0x0603, BOOLEAN)) \
	_(XRT_INPUT_NOLO_TRACKPAD                          , XRT_INPUT_NAME(0x0605, VEC2_MINUS_ONE_TO_ONE)) \
	_(XRT_INPUT_NOLO_TRACKPAD_CLICK                    , XRT_INPUT_NAME(0x0606, BOOLEAN)) \ 
	_(XRT_INPUT_NOLO_TRACKPAD_TOUCH                    , XRT_INPUT_NAME(0x0607, BOOLEAN)) \ 
	_(XRT_INPUT_NOLO_GRIP_POSE                         , XRT_INPUT_NAME(0x0608, POSE)) \
	_(XRT_INPUT_NOLO_AIM_POSE                          , XRT_INPUT_NAME(0x0609, POSE)) \
\
	_(XRT_INPUT_GENERIC_FACE_TRACKING                  , XRT_INPUT_NAME(0x0700, FACE_TRACKING)) \
\
	_(XRT_INPUT_HTC_EYE_FACE_TRACKING                  , XRT_INPUT_NAME(0x0701, FACE_TRACKING)) \
	_(XRT_INPUT_HTC_LIP_FACE_TRACKING                  , XRT_INPUT_NAME(0x0702, FACE_TRACKING))
...
enum xrt_output_name
{
	...
	XRT_OUTPUT_NAME_NOLO_HAPTIC                 = XRT_OUTPUT_NAME(0x0071, VIBRATION),
